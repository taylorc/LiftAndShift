...
**Updated `tests\LiftAndShift.FunctionalTests\LiftAndShift.FunctionalTests.csproj`:**
- Removed: `Microsoft.EntityFrameworkCore.InMemory`
- Added: `Testcontainers` and `Testcontainers.MsSql`

### 2. CustomWebApplicationFactory

**File:** `tests\LiftAndShift.FunctionalTests\CustomWebApplicationFactory.cs`
...
```bash
dotnet test tests\LiftAndShift.FunctionalTests\LiftAndShift.FunctionalTests.csproj
```
