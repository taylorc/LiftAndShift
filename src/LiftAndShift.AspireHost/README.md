...
1. Set `LiftAndShift.AspireHost` as the startup project
...
```bash
dotnet ef migrations add MigrationName -c AppDbContext -p ../LiftAndShift.Infrastructure/LiftAndShift.Infrastructure.csproj -s LiftAndShift.Web.csproj -o Data/Migrations
```

To update the database:
```bash
dotnet ef database update -c AppDbContext -p ../LiftAndShift.Infrastructure/LiftAndShift.Infrastructure.csproj -s LiftAndShift.Web.csproj
```
